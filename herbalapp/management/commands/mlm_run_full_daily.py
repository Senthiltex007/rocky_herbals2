...
def run_full_daily_engine(run_date: date):
    ...
    # ------------------------------------------------------
    # 2️⃣ Sponsor Income (RUN ONLY ONCE)
    # ------------------------------------------------------
    for child in members:
        ...
        if sponsor and can_receive_sponsor_income(sponsor):
            sponsor_amount = (
            ...
            if sponsor_amount > 0:
                ...
                print(
                    f"✅ Sponsor {sponsor.member_id} credited "
                    f"{sponsor_amount} from child {child.member_id}"
                )
...
# ----------------------------------------------------------
# AUTO RUN SIGNAL WHEN NEW MEMBER ADDED
# ----------------------------------------------------------
